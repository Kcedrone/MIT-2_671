function [f1, params, uParams, fit_is_significant] = linear_fit(x, y, doPlots)
...
ft1 = fittype('slope*x+intercept', 'coefficients', {'slope', 'intercept'});

% The key to a good fit is good starting guesses
int_guess = 1;
slope_guess = 1;

f1 = fit(x, y, ft1, 'StartPoint', [slope_guess, int_guess]);
