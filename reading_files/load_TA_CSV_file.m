function [filenames, measurement, units, data] = load_TA_CSV_file(input_file)
% function [headers, data] = load_CSV_file(input_file)
% input_file is optional argument
% if no file is specified, UI prompt will open
% function returns cells with column headings from original file containing
% filename, measurement type, units, and an array of the numerical data
% contact Dr. Kevin Cedrone (kcedrone@mit.edu) for support requests
